...
class Resolver implements Expr.Visitor<Void>, Stmt.Visitor<Void> {
    ...
    private void declare(Token name) {
        // retrieve the topmost scope from scopes stack and put a
        // reference to the token into it, with false to indicate
        // that it is not yet defined
    ...
    public Void visitBreakStmt(Stmt.Break stmt) {
        ...
        if (!inWhile) {
            Lox.error(stmt.keyword, "Can't use break outside of loop.");
        }
        return null;
    }
    ...
    public Void visitSuperExpr(Expr.Super expr) {
        ...
        if (currentClass == ClassType.CLASS) {
            Lox.error(expr.keyword, "Can only use 'super' inside a method on a subclass.");
        }
